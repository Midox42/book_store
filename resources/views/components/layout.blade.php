<nav class="navbar navbar-expand-lg navbar-dark rounded-4 shadow-sm px-3 py-2 mb-4" style="background: linear-gradient(135deg, #111827 0%, #1f2937 100%); border: 1px solid rgba(255,255,255,0.08);">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center gap-2 fw-semibold text-white" href="{{ route('index') }}">
        ...
        <div class="ms-auto">
            <ul class="navbar-nav flex-row gap-2">
                <li class="nav-item">
                    <a class="nav-link btn btn-outline-light btn-sm px-3 py-2 rounded-pill" href="{{ route('index') }}">Home</a>
                </li>
                <li class="nav-item">
